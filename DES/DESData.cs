...
namespace DES
{
    static class DESData
    {
        ...
        /// 秘钥的IP置换
        /// </summary>
        public static int[] InitialKeyPermutation = {
        ...
        /// 数据的IP置换
        /// </summary>
        public static int[] InitialDataPermutation = new int[]{
        ...
        /// 密钥每轮位移位数
        /// </summary>
        public static int[] KeyShiftArray = { 1, 1, 2, 2, 2, 2};
        /// <summary>
        /// 密钥的下标置换PC
        /// </summary>
        public static int[] SubKeyPC = {
